...
function App() {
  ...
  const handleInspect = async (e) => {
    e.preventDefault();
    if (!state.url.trim()) {
      setState((s) => ({ ...s, error: "Please paste an X or Reddit video link." }));
      return;
    }
    ...
    try {
      ...
      const defaultItag = data.videoFormats?.[0]?.itag ?? "default";
      ...
      const message =
        ...
        "Unable to find video. Please check that it's a public X or Reddit link and try again.";
      setState((s) => ({
        ...s,
        loadingInspect: false,
        error: message,
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                X (Twitter) & Reddit Video Downloader
              </p>
            </div>
          </div>
      ...
      <main className="flex-1 flex items-center">
        <div className="w-full max-w-3xl mx-auto px-4 py-10">
          ...
          >
            <div className="space-y-2 mb-6">
              <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight">
                Download public videos instantly
              </h2>
              <p className="text-sm text-slate-400">
                Paste an X or Reddit video link below. Only public posts are supported.
              </p>
            </div>
            ...
            >
              <label className="block text-sm font-medium text-slate-200 mb-1">
                Video URL
                <span className="sr-only">Paste an X or Reddit video link</span>
              </label>
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="Paste X or Reddit video link"
              ...
              <div className="mt-8 space-y-5" aria-live="polite">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] gap-4 items-end">
                  <div className="space-y-2">
                    ...
                    We’ll fetch the video directly from the original source.
                    </p>
                  </div>
                  ...
                  <p className="mt-3 text-[11px] text-slate-500 text-center">
                    Downloads start immediately. Large videos may take longer.
                  </p>
                </div>
              </div>
            )}
            ...
            {!meta && !loadingInspect && !error && (
              <p className="mt-5 text-xs text-slate-500">
                Tip: Paste an X or Reddit video link and press Enter to start.
              </p>
            )}
          </section>
          ...
          <section className="mt-8 text-xs text-slate-500 flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between">
            <p>
              QuickXSave — Free video downloads from X and Reddit
            </p>
            <p className="text-[11px]">
              Only works with public posts. Respect content creators and platform terms.
            </p>
          </section>
        </div>
      </main>
